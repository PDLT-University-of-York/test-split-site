...
You can also copy an embed code which can be used to display the presentation in a frame on the page. See the [guide to the Document HTML block](../../ultra/documents.md#block-html) for details of how to do this in the VLE. 
