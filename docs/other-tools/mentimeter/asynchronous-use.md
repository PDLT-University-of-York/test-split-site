...
You can also copy an embed code which can be used to display the presentation in a frame on a VLE page. The following [embedding content](../../ultra/embed-content.md) guidance shows you how to do this in the VLE. 
