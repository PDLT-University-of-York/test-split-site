...
### AI tool: open response grouping and summarising
...
</br>Alternatively, select the [insights button](https://help.mentimeter.com/en/articles/9538597-the-insights-button) and choose 'Groups'.
<br />![decorative](images/question-types-open-summarising-tool3.jpg)
...
Alongside the grouping function, an AI-powered summarising tool is also available when more than 10 responses have been received.  This provides a list of key points/headlines illustrated with an emoji for each.
