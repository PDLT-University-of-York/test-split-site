...
??? Tip "Open for full selectable list of shortcut keys"
...
However, you can also switch to 'survey mode' if you would like participants to be able to work through questions in their own time. This can be used to allow groups and individuals to respond at their own pace during teaching sessions, or to gather responses in advance of sessions for feedback, follow up, or to seed activities and discussion in the session itself.  Survey mode makes all the question types and features in Mentimeter available for asynchronous access to support online learning and independent study between live sessions.
