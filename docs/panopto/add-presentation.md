...
# Add presentation slides to your recording

!!! Summary

    You can attach a slide deck (presentation) to an existing Panopto video.

Adding the slides into a lecture capture recording can make it more accessible and easier to follow.

1. In the video editor interface, click on **Slides** in the left navigation menu.
