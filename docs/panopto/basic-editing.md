...
![Decorative](Images/basic-edits-launch-web-editor.png)
...
The key areas of the Panopto web editor interface are:

- The video viewer [A]
- Video timeline [B]
- Apply button [C]
- Preview button (to playback as a viewer) [D]

![DecorativePanopto web editor interface showing areas listed above](Images/panopto-basic-edits-view.png)
...
</br>![Decorative](Images/basic-edits-cut.png)
...
![Decorative](Images/basic-edits-apply-button.png)

## Removing Cuts

Remove any unwanted cutes in one of two ways: 
...
![Decorative](Images/basic-edits-remove-cuts.png)
