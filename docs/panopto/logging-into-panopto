...
![Annotated screenshot of Panopto log in screen](Images/log-in-1.png)
5. Enter in your UoY credentials (just your username without the @york.ac.uk and your IT account password).
![Annotated screenshot of Blackboard log in screen](Images/log-in-2.png)
6. Follow any Duo two-factor authentication steps as required.


!!! Tip 
    Anyone that uses our Canvas VLE (https://onlinestudy.york.ac.uk/) and studies or works on our York Online Distance Learning programmes should select the **York Online** option as shown below. Maths students should use this option. 

![Annotated screenshot of Canvas online log in option selected](Images/log-in-3.png)
