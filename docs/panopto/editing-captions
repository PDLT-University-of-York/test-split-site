...
!!! info Important - Please note the following before reading on: 
...
[Guidance on hiding individual videos (making them “unavailable”)](https://docs.google.com/document/d/15NNafw1G7QRZugOoCx2IkPbA4v1p58LvbTxXbV8wrJE/edit#heading=h.8h777z3bd659).
...
1. **Access the Captions Tab**  
   ...
   ![Captions tab in web editor](Images/cpations-tab.png)
...
2. **Review and Edit Captions**  
   ...
   ![Manually editing captions in Panopto](edit-captions.png)
...
If you encounter issues or need further help:
...
- For further support, Contact us at [vle-support@york.ac.uk](mailto:vle-support@york.ac.uk).