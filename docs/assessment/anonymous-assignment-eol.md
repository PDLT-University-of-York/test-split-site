...
## Background
The anonymous assignment building block was retired in September 2023. All "in VLE" file based summative assessments should now be [set up using the new Turnitin Feedback Studio submission points](../assessment/tfs/set-up.md) from within a Learn Ultra site.
...
!!! Tip
    ...
    We will need to reenable Learn Ultra (VLE) access for students returning from LoA before they can submit assessments. See our [guide to Assessment and Leave of Absence](../assessment/assessment-loa.md) for details.