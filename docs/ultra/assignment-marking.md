...
??? Info "More detail on using other annotation options"
    ...
    **1. Draw/write**
    ...
    ![decorative](images/assignment-marking-annotation-draw.png)
    ...
    **2. Image/file**
    ...
    ![decorative](images/assignment-marking-annotation-image.png)
    ...
    **4. Text box**
    ...
    ![decorative](images/assignment-marking-annotation-text.png)
    ...
    **5. Line/shape**
    ...
    ![decorative](images/assignment-marking-annotation-line.png)
