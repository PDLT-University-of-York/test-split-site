...
!!! Summary
    ...
    Images can be added into Documents in or between chunks of text. Images can only be viewed within Documents. Images cannot be cropped or resized after being added to a Document, so make sure to add the final version.
...
!!! Warning
    ...
    Images added via static URL cannot currently be marked as decorative. Instead, please provide a bconcise description of the image in the alternative text box.
