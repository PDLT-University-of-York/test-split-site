...
![Module information section and pages: described in text](images/prepare-site-module-specific-information.png)
</div>
...
<figure markdown="span">
![Assessment section and pages: as described in text, plus submission points: formative project proposal, summative group presentation, summative project final report](images/prepare-site-assessment-section.png)
...
<figure markdown="span">
![Week 5: navigation and route planning folder. Documents for lecture notes and workshop, practice quiz, discussion board activity](images/prepare-site-materials-example.png)
...
<figure markdown="span">
![Example Reading List with weekly structure, importance tags and direct access link](images/prepare-site-readinglist-example.png)
...
<div markdown class="centered-image">
![decorative](images/prepare-site-general-settings.png)
</div>
