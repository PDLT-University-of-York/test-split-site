...
![Clicking the purple plus icon between two content items in the Course Content area and then clicking on Create](images/discussions-setup-purple-plus-menu.png)
![Clicking on Discussion in the Create Item pane](images/discussions-setup-adding-discussion.png)
![Adding a title to a discussion board by clicking on the title at the top of the New Discussion pane](images/discussions-setup-setting-title.png)
![Adding a first post to a discussion forum and clicking save](images/discussions-setup-first-post.png)
![Clicking the Discussion Settings gear icon](images/discussions-setup-discussion-settings.png)
