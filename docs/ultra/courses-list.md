...
![Courses link shown within the left hand navigation bar on the VLE home page](images/courses-list-main-nav.png)
...
![decorative](images/courses-list-layout.png)
...
![Searching for 'zoo' returns the site 'Cryptozoology 101'](images/courses-list-search.png)
...
![Terms drop-down menu options: 'All terms' and each academic year you have enrollments for](images/courses-list-terms.png)

### Filters

Filter sites based on your role in the site or the course access status.

![Filter options in text](images/courses-list-filter.png)
...
![decorative](images/courses-list-remove-criteria.png)
...
![decorative](images/courses-list-favourite.png)
...
</br>![decorative](images/courses-list-course-image.png)
...
![decorative](images/courses-list-communities-nav.png)
</div>
</div>