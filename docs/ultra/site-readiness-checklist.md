...
??? essential "1.1 The site has been created and you have access"
    ...
    - If you’re enrolled on a site, find it in your Course list by searching for the SITS code and/or module name. You can Favourite the site to pin it to the top of your Course list.
...
??? essential "1.2 Other module teaching staff have access"
    ...
    For 23/24, staff enrollments will NOT be copied from previous year’s site, so check that any other module staff (guest lecturers, GTAs etc.) have access:
...
??? essential "2.1 Accessibility"
    ...
    - Meaningful **images and figures** have appropriate ALT text or other descriptions to allow screenreader users to access the information. See our [images guide](https://vle-support.york.ac.uk/ultra/images/) for more information.
    - **Link text** describes where the link goes or the content, eg. how to write better link text. Don’t use non-descriptive text like ‘click here’ or ‘find out more’. Don’t paste the full URL (eg. https://www.link.com). See our [links guide](https://vle-support.york.ac.uk/ultra/links/) for more information.
    - **File titles** describe the content without having to open the file. This could include the week, type of materials, key word(s) relating to the topic, and a short module identifier. For example, material titles for the module ‘Mythical Creatures in Literature’ could use the format Week 3_Slides_Dragons_MCL. See our [files guide](https://vle-support.york.ac.uk/ultra/files/) for more information.
    ...
    For more detail, see our [guide to accessible Ultra content](https://vle-support.york.ac.uk/ultra/accessible-ultra-content/). You can also attend our [Creating Accessible Documents workshop](http://bit.ly/eaccess-training) for a practical introduction.

??? essential "2.2 Template set-up"

    - The site uses the overall structure provided in the template. For most sites this includes sections for Module Information, Assessment and site materials (usually weekly sections), and Reading List and Replay Content areas.
    ...
    For more details, see our [guide to using the Ultra template](https://vle-support.york.ac.uk/ultra/ultra-template/).

??? essential "2.3 Assessment information"
...
??? essential "2.4 Site materials"
    ...
    **For 23/24, site content will NOT be automatically rolled over from the previous year’s site**, so extra care need to be taken to make sure that materials are ready for teaching.
    ...
    - Items are visible. In Ultra, items are hidden from students by default and must be manually made visible. You can either change [content visibility](https://vle-support.york.ac.uk/ultra/content-visibility/) as you create items, or use the [batch edit function](https://vle-support.york.ac.uk/ultra/batch-edit/) to change the visibility of many items at once. Remember not to make the Staff: Ultra Guides section visible.
    ...
    - Any content added using the Copy Content tool appears in the correct location and format, and has been restructured if needed. This is especially important for content copied from an Original site. For more information, see our [guide to Reusing Orginal content in Ultra](https://vle-support.york.ac.uk/ultra/reuse-original-content/).

??? essential "2.5 Video content (including Lecture Capture/Panopto)"
...
??? essential "2.6  Reading List"
    ...
    - For assistance please contact the Library (lib-readinglists@york.ac.uk) or see the [Reading List guide](https://subjectguides.york.ac.uk/readinglists/home)

??? essential "2.7 Web links and embedded content/third party tools (eg. Padlet, Xerte)"
    ...
    - [guide to adding Links](https://vle-support.york.ac.uk/ultra/links/)
    - [guide to embedded content](https://vle-support.york.ac.uk/ultra/embedded-content/)

??? essential "2.8 Groups"

    If you’re planning to use Groups within your site (eg. for seminar or project groups), check that these have been set up correctly. See our [guide to Groups](https://vle-support.york.ac.uk/ultra/groups/) for more details.
...
??? essential "3.1 Students are enrolled"
...
??? essential "3.2 The site is open to students"
