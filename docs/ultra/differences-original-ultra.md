...
![A Learning module (nesting level 1) containing a folder (nesting level 2), which contains a document (content only at this level).](images/differences-ultra-nesting.png)
...
![Original example: content item with text and file content is displayed with a Folder with text and image in description and a Learning Module](images/differences-original-display-content.png)
...
![Ultra example: a folder where only item titles are displayed. Users must open the Document to display content.](images/differences-ultra-display-content.png)
