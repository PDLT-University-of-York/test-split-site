...
</br>![decorative](images/export-course-package-menu.png)
...
</br>![decorative](images/export-course-package-manual.png)
...
</br>![List of automatic backup files with created date shown under name](images/export-course-package-automatic.png)
...
</br>![decorative](images/export-course-package-import.png)
2. On the *Import Content* menu, select **Import Course Content**.
</br>![Import Content menu with options Import Course Content, Content Market and Content Collection](images/export-course-package-import-menu.png)
