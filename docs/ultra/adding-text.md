...
![Screenshot of a block of lorem ipsum text with various heading levels](images/adding-text-all-styles)
4. You can insert standard LaTeX into text within double dollar signs, and it will render when the text chunk is saved.
![Two screenshots above one another. The top shows raw LaTeX input and the bottom shows it rendered into a mathematical expression](images/adding-text-latex)
...
![Screenshot of selected text, highlighting the Link tool](images/adding-text-hyperlink-button.png)
...
![Screenshot of the Link tool menu](images/adding-text-link.png)
