...
<figure markdown>
![Module information section, Assessment section, Reading List, Panopto folder, Weekly materials sections](../accessibility/images/index-template.png)
...
<figure markdown>
![Panopto Link item in the Course Content area](images/accessible-sites-panopto-link.png)
...
<figure markdown>
![Showing overall score, content breakdown and quick start points to fix](images/ally-acccessibility-report-overview-panel.png)
