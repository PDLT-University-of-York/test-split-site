...
</br> ![Release conditions is the third option in the drop down](images/release-conditions-select-visibility-option.png) 
2. Under **Select members**, click **Specific members or groups**.
</br> ![Decorative](images/release-conditions-specific-members-groups.png)
3. Specific student(s): click **Individual members**, type the name of the student, then click the student's name.
</br> ![Decorative](images/release-conditions-select-student.png)
4. Specific Group(s): click **Groups** then and select the desired group(s) from the drop down menu.
</br> ![Decorative](images/release-conditions-select-group.png)
5. Click **Save**.
...
</br> ![Decorative](images/release-conditions-appears-when.png)
5. Click **Save**.
...
</br> ![Decorative](images/release-conditions-performance.png)
3. Set the performance criteria from the **Mark requirement** list.
</br> ![Decorative](images/release-conditions-mark-requirement.png)
4. Click **Save**.
