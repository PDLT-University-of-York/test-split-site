...
Use the HTML block to embed third-party content, such as [interactive Xerte objects](../other-tools/xerte.md), [Padlet pinboards](../other-tools/padlet.md) or [asynchronous Mentimeter surveys](../other-tools/mentimeter/asynchronous-use.md). You can also manually embed Panopto or YouTube videos this way.
