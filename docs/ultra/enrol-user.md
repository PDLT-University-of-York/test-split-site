...
4. Click **“Find Users to Enrol” button** toward the top left of the screen.
    ...
    ![Find Users to Enrol button above search field](images/enrol-user-find-users-to-enrol.png "Find Users to Enrol")
...
1. The user is already enrolled on your course / organisation and able to access it. 
    ...
    ![Searching for a user already enrolled on the course](images/enrol-user-search-user.png "User search")
