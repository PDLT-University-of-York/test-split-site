...
![Selecting the View Sets & Groups option from an Ultra site's home page](images/groups-setup-view-sets-groups.png)
![Selecting New Group Set in the Course Groups pane](images/groups-setup-new-group-set.png)
![Typing in a name for the new Group Set in the Group Set pane](images/groups-setup-type-group-name.png)
![Selecting Randomly Assign from the Group Students drop down menu](images/groups-setup-randomly-assign.png)
![Selecting the number of groups to randomly assign students to in the Number of Groups drop down menu](images/groups-setup-number-of-groups.png)
![Adding a group's name and description in the Group Set Pane](images/groups-setup-name-description.png)
...
![Selecting New Group Set in the Course Groups pane](images/groups-setup-new-group-set.png)
![Typing in a name for the new Group Set in the Group Set pane](images/groups-setup-type-group-name.png)
![Selecting members for a group in the Group Set pane and then clicking the three dots next to a group member's name](images/groups-setup-selecting-members.png)
![Selecting Create New Group from the three dots icon menu](images/groups-setup-create-new-group.png)
![Adding a group's name and description in the Group Set Pane](images/groups-setup-manual-name-description.png)
...
![Selecting New Group Set in the Course Groups pane](images/groups-setup-new-group-set.png)
![Typing in a name for the new Group Set in the Group Set pane](images/groups-setup-type-group-name.png)
![Setting a group to visible to students in the Group Set pane](images/groups-setup-self-enrol-visibility.png)
![Selecting self-enrolment from the Group Students drop down menu](images/groups-setup-self-enrol-menu.png)
![Typing a description for a self enrol group set](images/groups-setup-self-enrol-description.png)
![Setting the start and end dates for enrolment and the maximum members per group, then clicking save in the Group Set pane](images/groups-setup-self-enrol-dates-members-save.png)
...
![Selecting a group set from the group set pane](images/groups-setup-move-select-group-set.png)
![Selecting a student, selecting a group to move the student to, and then clicking save](images/groups-setup-move-student-group-save.png)