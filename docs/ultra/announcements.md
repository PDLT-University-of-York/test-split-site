...
Announcements go to everyone enrolled on your VLE site, staff and students. Want to target your message to a small audience? Use [the Messages tool](https://vle-support.york.ac.uk/ultra/messages-tool/), instead.
...
3. On the **New Announcement** page, enter **a descriptive title** and **information** you want students to see as the announcement. Optionally, use the toolbar in the **message editor** to format text, embed multimedia, and attach files. You can also choose your recipients by clicking the **down arrow**.
    ...
    ![Edit title and information](images/announcement-edit.png "Edit")
4. You can use the **Send an email copy to recipients** for critical announcements (e.g. changes of exam schedule). Students will receive emails at the address associated with their VLE account, even if they don’t log into the course.
    ...
    ![Click on "send an email copy to recipients"](images/announcement-send-email.png "Send an email copy")
...
5. Use the **Schedule Announcement > Show on/Hide on dates** if you want the announcement to be visible for a specific time period.
    ...
    ![Schedule announcement](images/announcement-schedule.png "Schedule")
6. Click **Save**. Your announcement is saved as a draft on your Course Announcements page.

    ![click save](images/announcement-save.png "Click save")
...
1. Find the announcement you want to edit, copy or delete. On the right, click the **three dots > Edit/Copy/Delete.**
    ...
    ![Choose edit/copy/delete](images/announcement-edit-copy-delete.png "edit/copy/delete")
...
* **Pop-up window**
    ...
    ![View announcement on pop-up window](images/announcement-pop.png "Pop-up window announcement")
...
* **Activity stream**
    ...
    ![View announcement on activity stream](images/announcement-stream.png "Activity stream announcement")
...
* **Course content page**
    ...
    ![Search announcement on course content page](images/announcement-search.png "Search announcement")
