...
!!! Tip
    ...
    Mark Schemas can be applied to built-in Ultra assessment tasks only (eg. [Assignment](../ultra/assignment-set-up.md) and [Test](../ultra/test.md)). They cannot be applied to Turnitin Feedback Studio or Gradescope assessments.
