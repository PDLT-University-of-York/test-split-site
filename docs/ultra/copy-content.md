...
</br>![Adding content inside a Learning Module. Copy content is the 2nd item on the menu](images/copy-content-open-tool.png)
...
5. The Course Content area of the origin site is now shown. Navigate through to select the content you need:
    ...
    </br>![decorative](images/copy-content-select-learning-module.png)
    - To move back up a level, use the breadcrumbs above the content list.
    </br>![Breadcrumbs: Courses > origin site name > ... (Content) > specific folder name](images/copy-content-breadcrumbs.png)
6. Check the Items Selected to copy, and remove any that aren't needed. Click **Start Copy** and wait for the copy to complete.
</br>![decorative](images/copy-content-check-start-copy.png)
