...
<br> ![Annotated screenshot of the Ultra interface, highlighting the Copy Content button](images/copy-content-copy-content.png) <br>
...
4. Click **Content**.
<br> ![Two annotated screenshots side by side, highlighting a course in the courses list and the Content section on the next page](images/copy-content-select-course-content.png) <br>
5. Select the content items you want to copy using the checkboxes next to each item’s name.
<br> ![Screenshot of the Ultra interface, with two items of course content selected to be copied](images/copy-content-start-copy.png) <br>
