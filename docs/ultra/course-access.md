...
- **Main course page**
</br>An *Open* or *Closed* label appears in the top right of the page.
</br>![decorative](images/course-access-status-pill-in-site.png)
- **Course Settings page**
</br>An *Open* or *Closed* label appears at the top of the Course Access section.
</br>![decorative](images/course-access-status-course-settings.png)
...
</br>![decorative](images/course-access-update-settings.png)
...
![Toggle to mark Course as complete and prevent changes. When course is complete, learners cannot participate and instructors cannot make changes](images/course-access-mark-course-complete.png)