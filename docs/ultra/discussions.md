...
<figure markdown>
![Notification: date, site Ycode, module name, New discussion activity: discussion name, View Discussion button](images/discussion-notification-email.png)
<figcaption>Email notification of new discussion activity</figcaption>
</figure>
<figure markdown>
![Notification: date, module name, New discussion activity: discussion name](images/discussion-notification-stream.png)
...
![Groupwork discussion assigned to 3 groups](images/discussion-groups.png)
...
![Decorative](images/discussion-post-first.png)
3. Click **Save**.
