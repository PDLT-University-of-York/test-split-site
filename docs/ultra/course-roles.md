...
!!! Warning
   ...
   The Guest role is not available for individual users in Ultra sites, so users manually assigned this role will not be able to access a site. **Don't give an individual the Guest role**.
