...
![Navigation menu: described in text below](images/navigation-nav-menu.png)
...
<figure markdown>
![Home page: described in text](images/navigation-home.png)
...
<figure markdown>
![Courses page; search and filter boxes at top, then list of sites](images/navigation-courses.png)
