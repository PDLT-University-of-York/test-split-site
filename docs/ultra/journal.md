...
3. Add a **prompt** with instructions into the text box, or click **Auto-generate Journal** to [use AI to generate a journal prompt](#generate-journal-prompts-with-ai).
...
You can use the [AI Design Assistant Tool](../ultra/ai-da.md) to auto-generate Journal prompts based on your site content. 
