...
??? essential "Essential principles: must meet"
    ...
    Essential principles are regulatory in nature, relating to **complying with legislation** or **implementing UoY policy**.
    Sites must meet all of these principles.
    More information:
    
    - legislation: [accessibility](https://sites.google.com/york.ac.uk/uoyaccessibility/creating-accessible-documents?authuser=0), [copyright](https://subjectguides.york.ac.uk/copyright/teaching).
    - UoY policy: [assessment](https://www.york.ac.uk/staff/teaching/learning-design/assessment/guide/), [Inclusive Learning](https://www.york.ac.uk/staff/teaching/inclusive-learning/), [Reading List](https://subjectguides.york.ac.uk/readinglists), [captioning](https://docs.google.com/document/d/1_NjwLqE2gYrt11JgCYWYLoWnj2xG3B_yi3xuUgvbHkQ/edit?usp=sharing).
