...
!!! Summary
    ...
    Messages are a targeted one-way communication channel for updates sent to specific users or groups.
...
## Sending Messages: which way?
There are two main ways to use Messages depending on how you want messages to appear: 

- **Way 1: appear in the VLE (and optionally via email)** - activate the Messages tool for your site  
    This allows for messages via email and/or messages that also appear in the VLE.  An extra ‘Messages’ menu item will be added both at the top of the course VLE site. See the "How do students access my messages?" section below for more details.
- **Way 2: Appear only via email** - *don't* activate the whole Messages tool for your site
...
![decorative](images/messages-groups.png)
...
![decorative](images/messages-gradebook.png)
...
![Decorative](images/messages-left-nav-link.png)

- from the "Messages" tab in the top navigation menu of the course site. 

![Decorative](images/messages-course-link.png)
